 ...
 */
class OrphanedFileScanStateProcessor implements ProcessorInterface
{
    public function __construct(
        private readonly ?MessageBusInterface $messageBus,
        private readonly ScanOrphanedFilesHandler $handler,
    ) {
    }

    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): null
    {
        $message = new ScanOrphanedFilesMessage();
        if ($this->messageBus) {
